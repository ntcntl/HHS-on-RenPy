...
screen description(what):
    ...
    fixed xpos 0.01 ypos 0.7:
        vbox:
            if what == 'usual':
                text _('Ученикам будет разрешено приходить в школу в обычной одежде, что позволит им быть более раскрепощёнными, а также увеличит радость пребывания в "строгих" стенах вашего заведения. Требует пройти проверку на лояльность вам учителей.')
            elif what == 'strict':
                ...
                text _('Сексуальная одежда требует пройти проверку на развратность у учителей. Она даст снижение скромности учителей и учеников ежедневно, вплоть до средних значений. Также она будет повышать развратность учителей и учеников ежедневно. Ну и бонусное возбуждение прямо с утра.')
            elif what == 'skimpy':
                ...
                text _('Голая форма требует пройти проверку на развратность у учителей. Она даст сильное снижение скромности учителей и учеников ежедневно, вплоть до нуля. Также она будет повышать развратность учителей и учеников ежедневно, вплоть до максимума.')
            elif what == 'education':
        ...
        hbox:
            ...
            for teacher in teachers:
                ...
                if mile_qwest_1_stage == 2 and teacher == mustangovich:
                    $ amount = -1
                if mile_qwest_1_stage == 1 and teacher == mustangovich:
                    $ amount = amount/2
                vbox:
                    spacing 10
                    if type == 'loy':
