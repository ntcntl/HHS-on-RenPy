init python:
    def textgen(char):
        global him_zavivka, depilation, skin_care, manicure, pedicure, playerTan
        description = ''
...
#########################################
            ...
            if playerTan < 3:
                description += 'Фраза "бледная поганка" довольно чётко характеризует цвет моей кожи. Надо почаще вылазить из школы.\n'
            elif playerTan < 6:
                description += 'У меня слегка загорелая кожа.\n'
            elif playerTan < 9:
                description += 'У моей кожи приятный оттенок топлёного молока с шоколадом.\n'
            elif playerTan < 12:
                description += 'По моей коже сразу видно, что я обожаю нежиться в лучах солнца! И делаю это каждый день! \n'
            else:
                description += 'Моя кожа глубокого тёмного оттенка. Я ещё не негр, но вполне сойду за беженку из арабских стран! Только хиджаба нехватает... \n'
