init -3 python: 
    ...
    loyMod = 1.0 # Модификатор скорости роста лояльности
    ...
    movedArray = [] # Массив принудительно перемещённых персонажей
    ...
    hasToiletPics = 0 # Есть ли фотки с камеры
    useClothesReputation = 1 # Использовать ли снятие репутации за одежду
