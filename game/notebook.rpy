        ...
        vbox:
            ...
            if mile_qwest_2_stage_init == 1 or development == 1 or mile_qwest_2_stage > 0:
                ...
                if mile_qwest_2_stage == 0:
                    ...
                    text _('[kupruvna.name] всегда будет поддерживать меня на голосовании. К сожалению, после вашего напора, её отношения с сыном закончились. Зато она стало абсолютно безвольной и теперь прибирается в моём кабинете по утрам!')
            ...
            if mile_qwest_3_stage_init > 0 or mile_qwest_3_stage > 0:
                ...
                if mile_qwest_3_stage == 0:
                    ...
                    text _('[danokova.name] стала невероятно доминантной. Или всегда была? Впрочем это неважно. С её уровнем разврата она не откажется, даже если я предложу всем после уроков запихивать себе швабры в одно место!')
                elif mile_qwest_3_stage == 50:
