...
label event_loc_class3Learn_0_3:
    ...
    if player.getCorr() > 40:
        ...
        'Вы с удовольствием представили, как [st1.fname], стоя в коридоре на перемене, засовывает член своего парня прямо в рукав школьного пиждака, и начинает его массировать. Да, на её бы месте даже вы не стали бы доводить мужчину до оргазма, так как ходить весь день в мокром от спермы пиджаке приятного мало.'
    $ move(curloc)
